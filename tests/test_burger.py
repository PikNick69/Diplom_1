...
class TestBurger:
    ...
    def test_remove_ingredient_valid(self, index):
        burger = Burger()
        for _ in range(3):
    ...
    def test_move_ingredient_valid(self, old, new, expected_order):
        burger = Burger()
    ...
    def test_move_ingredient_invalid_old_index(self):
        burger = Burger()
        burger.add_ingredient(Mock(spec=Ingredient))
        with pytest.raises(IndexError):
            burger.move_ingredient(5, 0)

    def test_move_ingredient_invalid_new_index(self):
        burger = Burger()
        burger.add_ingredient(Mock(spec=Ingredient))
        burger.add_ingredient(Mock(spec=Ingredient))
    ...
    def test_get_price_with_bun_and_ingredients(self, mock_bun, mock_ingredient):
        burger = Burger()
        burger.set_buns(mock_bun)
        burger.add_ingredient(mock_ingredient)
    ...
    def test_get_price_with_bun_only(self, mock_bun):
        burger = Burger()
        burger.set_buns(mock_bun)
        expected = mock_bun.get_price() * 2
        assert burger.get_price() == expected

    def test_get_price_without_bun(self, mock_ingredient):
        burger = Burger()
        burger.add_ingredient(mock_ingredient)
        with pytest.raises(AttributeError):
            burger.get_price()

    def test_get_receipt_with_bun_and_ingredients(self, mock_bun, mock_ingredient):
        burger = Burger()
        burger.set_buns(mock_bun)
        burger.add_ingredient(mock_ingredient)
    ...
    def test_get_receipt_with_bun_only(self, mock_bun):
        burger = Burger()
        burger.set_buns(mock_bun)
    ...
    def test_get_receipt_without_bun(self, mock_ingredient):
        burger = Burger()
        burger.add_ingredient(mock_ingredient)
        with pytest.raises(AttributeError):
            burger.get_receipt()

    def test_get_receipt_multiple_ingredients(self, mock_bun):
        burger = Burger()
        burger.set_buns(mock_bun)
